...
if (isset($_POST['login'])) {
	if (isset($_POST['email']) && isset($_POST['password'])) {
		...
		$result = mysqli_query($link,"SELECT * FROM user WHERE (email='$user_login') AND password='$password_login_md5' AND activation='yes'");
		...
		if ($num>0) {
			...
			$result1 = mysqli_query($link,"SELECT * FROM user WHERE (email='$user_login') AND password='$password_login_md5' AND activation='no'");
...
if(isset($_POST['activate'])){
	if(isset($_POST['actcode'])){
		$user_login = mysqli_real_escape_string($link,$_POST['acemail']);
		$user_login = mb_convert_case($user_login, MB_CASE_LOWER, "UTF-8");
		$user_acccode = mysqli_real_escape_string($link,$_POST['actcode']);
