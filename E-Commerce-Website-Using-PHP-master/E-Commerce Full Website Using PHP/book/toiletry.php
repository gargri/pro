...
<body>
	...
	<div class="categolis">
		<table>
			<tr>
				<th>
					<a href="Engnieering.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;">Engnieering</a>
				</th>
	...
	<div style="padding: 30px 120px; font-size: 25px; margin: 0 auto; display: table; width: 98%;">
		<div>
		<?php
			$getposts = mysqli_query("SELECT * FROM products WHERE available >='1' AND item ='toilatry'  ORDER BY id DESC LIMIT 10") or die(mysql_error());
