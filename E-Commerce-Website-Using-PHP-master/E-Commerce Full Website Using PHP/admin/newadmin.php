...
$_POST['last_name'] = trim($_POST['last_name']);
	try {
		...
		$check = 0;
		$e_check = mysqli_query($link,"SELECT email FROM `admin` WHERE email='$u_email'");
			...
			if ($check == 0 ) {
				if ($email_check == 0) {
					if (strlen($_POST['password']) >4 ) {
						...
						$result = mysqli_query($link,"INSERT INTO admin (firstName,lastName,email,mobile,address,password,type,confirmCode) VALUES ('$_POST[first_name]','$_POST[last_name]','$_POST[email]','$_POST[mobile]','$_POST[signupaddress]','$_POST[password]','$_POST[admintype]','$confirmCode')");
		...
		<?php
			...
			>										</div>
													...
													<div>
														...
														font-style: italic;margin-bottom: 3px;margin-top: 0px;padding: 14px;line-height: 25px;border-radius: 20px;border: 1px solid black;margin-left: 0;width: 300px;background-color: transparent;" class="">
