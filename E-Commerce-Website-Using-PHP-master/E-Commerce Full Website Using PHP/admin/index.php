...
<html>
	...
	<body style="min-width: 980px; background-image: url(../book4.jpg);  background-size: cover;">
		...
		<div class="home-welcome">
			<div class="home-welcome-text">
				<h1 style="color:black;">Welcome To Admin Panel</h1>
				<h2 style="color:black;">You have all permission to do!</h2>
			</div>
		</div>
	</body>
</html>
