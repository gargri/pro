...
$getposts = mysqli_query($link,"SELECT * FROM products WHERE id ='$poid'") or die(mysql_error());
...
//triming name
	try {
		...
		// Check if email already exists
						...
						if(mysqli_query($link,"INSERT INTO orders (uid,pid,quantity,oplace,mobile,odate,ddate) VALUES ('$user','$poid',$quan,'$_POST[address]','$_POST[mobile]','$d','$date')")){

							//success message
						$success_message = '
						<div class="signupform_content"><h2><font face="bookman">Thank you!</font></h2>
						<h2><font face="bookman" style="margin-top:1px;">Order Successful!</font></h2>
